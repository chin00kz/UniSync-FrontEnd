      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7">
          {activeId && current ? (
                ...
                <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
                  ...
                  <div className="p-5 space-y-4">
                    <Textarea 
                      ...
                      className="min-h-30 resize-none focus:ring-2 focus:ring-brand-blue border-border bg-background"
                    />
                    
                    <div 
                      onDragOver={(e) => e.preventDefault()} 
                      onDrop={(e) => { e.preventDefault(); processFile(e.dataTransfer.files[0]); }} 
                      className="border-2 border-dashed border-border rounded-lg p-5 text-center hover:border-brand-blue hover:bg-brand-blue/5 transition-all duration-200 bg-muted/30"
                    >
                      {!replyImage ? (
                        <>
                          ...
                          <div className="relative inline-block">
                            ...
                            />
                            <Button variant="outline" size="sm" type="button" className="pointer-events-none bg-card">
            ...
            <Card className="border-0 shadow-sm h-full flex items-center justify-center min-h-100 bg-card">
